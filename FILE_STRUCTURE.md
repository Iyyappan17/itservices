...
```html
<!-- Logos -->
<img src="assets/images/logos/logo1.png" alt="Veyom">

<!-- Content Images -->
<div class="hero-slide" style="background-image: url('assets/images/content/person-working-html-computer.jpg');"></div>
```
